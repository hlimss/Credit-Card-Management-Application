<template>
  <div class="register-page min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center py-4 px-4 sm:px-6 lg:px-8">
      ...
      <div class="register-card-3d">
        <div class="card-inner-3d">
          <div class="card-header">
            ...
            <p class="card-subtitle">Join Token2Pay and start managing your cards</p>
          </div>
          ...
          <form @submit.prevent="handleRegister" class="register-form">
            ...
            <div v-if="error" class="form-error-3d">
              ...
              <div class="error-content">
                ...
                <p>{{ error }}</p>
                <small v-if="error.includes('connect') || error.includes('server')" class="error-hint">
            ...
            <div class="form-section">
              ...
              <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div class="form-group-3d">
                  <label for="firstName" class="form-label-3d">
                ...
                <div class="form-group-3d">
                  <label for="lastName" class="form-label-3d">
                    <span class="label-icon">📝</span>
                    Last Name *
                  </label>
                  <div class="input-wrapper-3d">
              ...
              <div class="form-group-3d">
                <label for="phoneNumber" class="form-label-3d">
                  <span class="label-icon">📱</span>
                  Phone Number <span class="optional-text">(Optional)</span>
                </label>
                <div class="input-wrapper-3d">
                  <input
                    id="phoneNumber"
            ...
            <div class="form-section">
              ...
              <div class="form-group-3d">
                <label for="confirmPassword" class="form-label-3d">
                  <span class="label-icon">🔒</span>
                  Confirm Password *
                </label>
                <div class="input-wrapper-3d">
            ...
            <button
              type="submit"
              :disabled="loading || (password !== confirmPassword) || !firstName || !lastName"
              class="submit-btn-3d"
            >
...
.register-card-3d:hover .card-inner-3d {
...
/* Old form-error-3d style - keeping for compatibility */
.form-error-3d-old {
  display: flex;
  align-items: center;
  gap: 0.75rem;
...
/* Custom Scrollbar */
.card-inner-3d::-webkit-scrollbar {
  width: 8px;
}

.card-inner-3d::-webkit-scrollbar-track {
  background: rgba(102, 126, 234, 0.1);
  border-radius: 4px;
}

.card-inner-3d::-webkit-scrollbar-thumb {
  background: linear-gradient(135deg, #667eea 0%, #764ba2 100%);
  border-radius: 4px;
}

.card-inner-3d::-webkit-scrollbar-thumb:hover {
